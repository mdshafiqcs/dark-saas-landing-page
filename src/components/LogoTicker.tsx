...
export const LogoTicker = () => {
  return <div className='bg-black text-white py-[72px] sm:py-24 '>
    <div className='container'>
      ...
      <div className="overflow-hidden mt-9 before:content-[''] after:content-[''] before:absolute after:absolute before:h-full after:h-full before:w-5 after:w-5 relative before:left-0 after:right-0 before:top-0 after:top-0 before:bg-[linear-gradient(to_right,black,transparent)] after:bg-[linear-gradient(to_left,black,transparent)] ">
