  ...
  return <div className='bg-black text-white py-[72px] sm:py-24'>
    <div className="container">
      ...
      <div className='max-w-xl mx-auto'>
        <p className='mt-5 text-center text-xl text-white/70 '>Enjoy customizable lists, team work tools, and smart tracking all in one place. Set tasks, get reminders, and see your progress simply and quickly.</p>
      </div>
